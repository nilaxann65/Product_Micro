using Product_Micro.Core.Interfaces;
using Product_Micro.Core.ProjectAggregate;
using Product_Micro.Core.ProjectAggregate.Events;
using Product_Micro.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace Product_Micro.UnitTests.Core.Handlers;
